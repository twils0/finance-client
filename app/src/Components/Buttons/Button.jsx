...
const ButtonStyle = styled.button`
  ...
  padding: ${props => props.padding || '1em 2.5em'};
  ...
  &:hover {
    ...
    background: ${props => props.color.selected || props.theme.color[props.themeColor].selected};
    color: ${props => props.background || props.theme.color.background[props.backgroundType]};
    border-color: ${props => props.color.selected};
  }

  &:disabled {
    background: ${props => props.color.disabled || props.theme.color[props.themeColor].disabled};
    color: ${props => props.background || props.theme.color.background[props.backgroundType]};
    border-color: ${props => props.color.disabled};
  }
`;
